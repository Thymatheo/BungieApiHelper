...
namespace BungieApiHelper {
    public sealed class BungieApiHelperConfig {
        ...
        private string _appRedirectUrl;
        ...
        public string AppRedirectUrl {
            get => _appRedirectUrl ?? throw new NullReferenceException("Unable to find the Application Redirecr Url Field in the configuration");
            set => _appRedirectUrl = value;
        }
    }
